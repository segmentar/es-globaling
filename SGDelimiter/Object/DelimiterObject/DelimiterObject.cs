    ...
    public partial class SGDelimiter
    {
        public override String ToString()
        {
            return String.Join('\n'.ToString(), new String[] {
                ...
                String.Empty + '\t' + '~' + "04" + ' ' + nameof(Empty) + ':' + ' ' + Empty,
                String.Empty + '\t' + '~' + "05" + ' ' + nameof(Lone) + ':' + ' ' + Lone,
                String.Empty + '.' + "compressed-raw",
                String.Empty + '\t' + '~' + "06" + ' ' + nameof(Text) + ':' + ' ' + ". . .",
                String.Empty + '\t' + '~' + "07" + ' ' + nameof(DelimiterList) + ':' + ' ' + ". . ." + ' ' + $"[{DelimiterList.Count}]",
                String.Empty + '\t' + '~' + "08" + ' ' + nameof(DelimiterRepresentationList) + ':' + ' ' + ". . ." + ' ' + $"[{DelimiterRepresentationList.Count}]",
                String.Empty + '}',
                String.Empty,
